...
<head>
    ...
    <!-- App favicon
        <link rel="shortcut icon" href="{{asset('assets/images/favicon.ico')}}" type="image">
         -->
    <!-- App css -->
                        ...
                        <div class="card-body p-4">
                            ...
                            <form action="{{route('admin.auth')}}" method='get'>
                                ...
                                <div class="mb-3">
                                    ...
                                    @error('email')
                                    <div class="bg-white text-danger" role="alert">
                                        {{$message}}
                                    </div>
                                    @enderror
                                </div>
                                ...
                                @if(session('message'))
                                <div class='row justify-content-center'>
                                    <div class="col-md-8 alert alert-danger alert-dismissible bg-danger text-white border-0 fade show"
                                        role="alert">
